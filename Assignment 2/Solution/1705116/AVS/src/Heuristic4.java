...
public class Heuristic4 extends  MancalaHeuristic{
    ...
    public int getHeuristicValue(MancalaBoard board) {
        ...
        if(W1==0){
            ...
            W4=new Random().nextInt(MAX_WEIGHT)+1;
        }
        ...
        int stonesCapture=board.getStonesMoved();
        return W1*(stones_in_my_storage -stones_in_opponents_storage)+W2*(stones_in_my_side-stones_in_opponents_side)+W3*extra_moves+W4*stonesCapture;
