...
public class Heuristic5 extends  MancalaHeuristic{
    ...
    public int getHeuristicValue(MancalaBoard board) {
        ...
        return W1*(halfTotalStones - stones_in_my_storage) + W1*(stones_in_my_storage -stones_in_opponents_storage)+W2*(stones_in_my_side-stones_in_opponents_side)+W3*extra_moves;
